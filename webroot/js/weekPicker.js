...
var showWeekCalendar = function(obj) {
...
var setWeekCalendar = function(settingElement) {
    ...
    var selectCurrentWeek = function() {
        window.setTimeout(function() {
            var hid_week = $("#hid_week").val();
            hid_week = hid_week.split("W");
            var activeElement = $("td.ui-datepicker-week-col:contains('"+hid_week[1]+"')");
            ...
            tdElement.find("td,a").css("background", "#2f3d54").css("color", "#ffffff");
        }, 1);
    };
    ...
    $(settingElement).datepicker({
        ...
        onSelect: function(dateText, inst) {
            ...
            var ywString = datepickerValue.getFullYear() + '-W' + weekNum;
            $(this).val(ywString);
...
var convertToWeekPicker = function(targetElement) {
    if (targetElement.prop("tagName") == "INPUT" && (targetElement.attr("type") == "text" || targetElement.attr("type") == "hidden")) {
        ...
        /*Set current week value into hidden variable*/
        $('<input>', {
            type: 'hidden',
            id: 'hid_week',
            name: 'hid_week',
