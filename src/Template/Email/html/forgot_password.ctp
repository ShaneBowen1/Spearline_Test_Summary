            ...
            <table style="width:721px;" border="0" cellspacing="0" cellpadding="0" id="the_content">
                ...
                <tr>
            		...
            		<td align="center" valign="top">
                        ...
                        <p style="text-align: left;margin-top: 10px; margin-bottom: 10px;">We've received a request to reset your password.If you didn't make the request disregard this email. Otherwise you can reset your password usig this link:</p>
                        <?= $this->Html->link(__("Click here to reset your password"), ["controller" => "User", "action" => "changeUserPassword", $random_string, '_full' => true], ["style"=>"height: 40px; width:100%; color:#FFF; display: block; background-color:#03A9F4; font-weight: bold;"]) ?>
                    </td>
                    <td width="50"></td>
                </tr>
                <tr>
