            ...
            <table style="width:721px;" border="0" cellspacing="0" cellpadding="0" id="the_content">
                ...
                <tr>
            		...
            		<td align="center" valign="top">
                        ...
                        <p style="text-align: left;margin-top: 10px; margin-bottom: 10px;">A Spearline administrator sent this email to you to reset your password.. If you didn't make the request disregard this email. Otherwise you can reset your password using this link:</p>
